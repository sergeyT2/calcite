...
public enum BuiltInMethod {
  ...
  UNIX_TIMESTAMP_TO_STRING(DateTimeUtils.class, "unixTimestampToString",
      long.class),
 // UNIX_DATE_TO_FORMATTED_STRING(DateTimeUtils.class,
   //   "unixDateTimeToFormattedString", long.class, String.class),
  ...
  INT_TO_STRING(SqlFunctions.class, "numericToChar", int.class, String.class),
